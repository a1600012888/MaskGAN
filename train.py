...
def main():
    ...
    parser.add_argument('--tv', type=float, default=1e-2, help = 'the weight of TV loss(Default:0.01)')
    parser.add_argument('--adv', type = float, default=1.00, help = 'the weight of adv loss(Default:10.0)')
